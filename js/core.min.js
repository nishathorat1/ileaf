    ...
    (function (d, e) {
        ...
        (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
            ...
            (i.prototype.thumbnail = function (e, t) {
                ...
                if (
                    (e.wrap(
                        d("<div/>", { class: "owl-video-wrapper", style: s })
                    ),
                    this._core.settings.lazyLoad &&
        ...
        function f(t, e) {
            t.parents(".cd-headline").hasClass("type")
                ...
                : t.parents(".cd-headline").hasClass("clip") &&
                  t
                      .parents(".cd-words-wrapper")
                      .animate({ width: t.width() + 10 }, h, function () {
                          setTimeout(function () {
                              p(t);
                          }, o);
                      });
            ...
            t.addClass("in").removeClass("out"),
                t.is(":last-child")
                    ? (e.parents(".cd-headline").hasClass("type") &&
                          setTimeout(function () {
                              e.parents(".cd-words-wrapper").addClass(
                                  "waiting"
                              );
                          }, 200),
                      i ||
            ...
            (function (t) {
                ...
                t.each(function () {
                    ...
                    o.hasClass("loading-bar")
                        ? ((n = s),
                          setTimeout(function () {
                              o.find(".cd-words-wrapper").addClass(
                                  "is-loading"
                              );
                          }, l))
                        : o.hasClass("clip")
                        ? ((e = (t = o.find(".cd-words-wrapper")).width() + 10),
                          t.css("width", e))
                        : o.hasClass("type") ||
                          ((e = o.find(".cd-words-wrapper b")),
                          (i = 0),
                          e.each(function () {
                              var t = r(this).width();
                              i < t && (i = t);
                          }),
                          o.find(".cd-words-wrapper").css("width", i)),
                        setTimeout(function () {
                ...
                l.waypoint(
                    function () {
                        for (
                            ...
                            if (
                                (n && (a = parseFloat((i / e) * r).toFixed(s)),
                                o)
                            )
                    ...
                    this.options.parallaxBackgrounds &&
                        ...
                        t.each(function () {
                            ...
                            if (s.data("stellar-backgroundIsActive")) {
                                if (
                                    s.data("stellar-backgroundIsActive") !==
                                    this
                                )
                                    return;
                    ...
                    this.each(function () {
                        ...
                        o
                            ...
                            "vertical" == l.type &&
                                o
                                    .find(
                                        ".resp-tabs-container." + l.tabidentify
                                    )
                                    .css(
                                        "border-color",
            ...
            (e.prototype.flushTriggers = function () {
                for (var t in this.triggerQueues) {
                    ...
                    for (var o = 0, n = e.length; o < n; o += 1) {
                        var s = e[o];
                        (!s.options.continuous && o !== e.length - 1) ||
                            s.trigger([t]);
                    }
                }
                this.clearTriggerQueues();
                ...
                (t.prototype.build = function () {
                    ...
                    if (
                        ...
                        this.core.s.animateThumb &&
                            n.$thumbOuter.css(
                                "height",
                                n.core.s.thumbContHeight + "px"
                            ),
                        n.core.s.dynamic)
                    )
                        for (var i = 0; i < n.core.s.dynamicEl.length; i++)
                            e(
                                n.core.s.dynamicEl[i].src,
                                n.core.s.dynamicEl[i].thumb,
                                i
                            );
                    else
                    ...
                    n.core.$outer.find(".lg-thumb").html(s),
                        (t = n.core.$outer.find(".lg-thumb-item")).each(
                            function () {
                                var e = a(this),
                        ...
                        t.on("click.lg touchend.lg", function () {
                            var t = a(this);
                            setTimeout(function () {
                                ((!n.thumbClickable || n.core.lgBusy) &&
                                    n.core.doCss()) ||
                ...
                (t.prototype.zoomSwipe = function () {
                    ...
                    n.core.$slide.on("touchstart.lg", function (t) {
                        ...
                        n.core.$outer.hasClass("lg-zoomed") &&
                            ...
                            ((l = e.allowX) || c) &&
                                (t.preventDefault(),
                                (s = n.getSwipeCords(t, Math.abs(d)))));
                    }),
    ...
    (function (t) {
        ...
        if (d.event.fixHooks)
            for (var o = t.length; o; )
                d.event.fixHooks[t[--o]] = d.event.mouseHooks;
                                ...
                                if (o && e)
                                    for (var s = 0, r = o.length; s < r; s++)
                                        o[s].fn !== e &&
                                            ...
                                            n.push(o[s]);
                                return (
                                    n.length ? (i[t] = n) : delete i[t], this
                                );
                            },
                        }),
                            (t.exports = i);
        ...
        var c = /\blang(?:uage)?-([\w-]+)\b/i,
            ...
            A = {
                ...
                highlightAllUnder: function (t, e, i) {
                    ...
                    for (
                        var n,
                            s = o.elements || t.querySelectorAll(o.selector),
                            r = 0;
                        (n = s[r++]);
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    (n.position = i.image.position),
                                        ...
                                        i.image.$container.appendChild(
                                            i.image.$item
                                        ),
                                        i.onResize(),
                                        i.onScroll(!0),
                                        i.options.automaticResize &&
                                            $ &&
                                            $.observe(i.$item),
                                        i.options.onInit &&
                                            i.options.onInit.call(i),
                                        "none" !==
                                            i.css(
                                                i.$item,
                                                "background-image"
                ...
                function E(t, e) {
                    ...
                    for (
                        ...
                        if (
                            ...
                            void 0 === i
                                ? t[s].jarallax ||
                                  (t[s].jarallax = new S(t[s], i))
                                : t[s].jarallax &&
                                  (r = t[s].jarallax[i].apply(
                                      t[s].jarallax,
                                      o
                                  )),
                            void 0 !== r)
                            ...
                            value: function (i) {
                                ...
                                return (
                                    ...
                                    Object.keys(arguments).forEach(function (
                                        ...
                                        o[e] &&
                                            Object.keys(o[e]).forEach(function (
                                                t
                                            ) {
                                                i[t] = o[e][t];
                                            });
                        ...
                        },
                        {
                            ...
                            value: function (i, o) {
                                ...
                                this.userEventsList &&
                                    ...
                                    (o
                                        ? this.userEventsList[i].forEach(
                                              function (t, e) {
                                                  t === o &&
                                                      (n.userEventsList[i][e] =
                                                          !1);
                                              }
                                          )
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                this.userEventsList &&
                                    ...
                                    this.userEventsList[t].forEach(function (
                                        t
                                    ) {
                                        t && t.apply(e, i);
                                    });
                                              ...
                                              "vimeo" === c.type &&
                                                  ((c.playerOptions = {
                                                      ...
                                                      loop: c.options.loop
                                                          ? 1
                                                          : 0,
                                                      muted: c.options.mute
                                                          ? 1
                                                          : 0,
                                                  }),
                                                  c.options.volume &&
                                                      (c.playerOptions.volume =
                                                          c.options.volume),
                                                  c.options.showContols ||
                ...
                (e.default = function () {
                    ...
                    t.prototype.onScroll = function () {
                        ...
                        e.apply(i),
                            i.isVideoInserted ||
                                !i.video ||
                                (i.options.videoLazyLoading &&
                                    !i.isElementInViewport) ||
                                i.options.disableVideo() ||
                                ((i.isVideoInserted = !0),
                    ...
                    t.prototype.coverImage = function () {
                        ...
                        return (
                            s &&
                                ...
                                ("IFRAME" === r || "VIDEO" === r) &&
                                ((e =
                                    ((t = s.image.height) * n.image.width) /
                                    n.image.height),
                                ...
                                if (
                                    ...
                                    e.on("started", function () {
                                        (i.image.$default_item = i.image.$item),
                                            ...
                                            (i.image.width =
                                                i.video.videoWidth || 1280),
                                            (i.image.height =
                                                i.video.videoHeight || 720),
                                            i.coverImage(),
                                            i.clipContainer(),
                                            i.onScroll(),
                                            i.image.$default_item &&
                                                (i.image.$default_item.style.display =
                                                    "none");
                                    }),
                                    e.on("ended", function () {
                                        (i.videoEnded = !0),
        ...
        (d.prototype.extend = function (t, e) {
            ...
            (this.WOW =
                ...
                (s.prototype.resetStyle = function () {
                    for (
                        var t, e, i = [], o = 0, n = (e = this.boxes).length;
                        o < n;
                        o++
                    )
